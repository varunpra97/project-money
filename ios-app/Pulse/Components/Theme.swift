...
extension Color {
    ...
    static let pulseBg = Color(white: 0.22)
    static let pulseCard = Color(white: 0.32)
    static let pulseSecondary = Color(white: 0.78)
    static let pulseTertiary = Color(white: 0.62)
}
