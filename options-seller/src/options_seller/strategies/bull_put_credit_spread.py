...
class BullPutCreditSpread(StrategyBuilder):
    ...
    def build(
        ...
        short = pick_suggested(
            legs_src, OptionRight.PUT, self.cfg, dte_lo=dte_lo, dte_hi=dte_hi, side="sell"
        )
        long = None
        ...
        if short is not None and long is not None:
            ...
            plan = OrderPlan(
                ...
                notes=f"Bull put credit spread width={width_act}",
        ...
        short_strike = round(price * 0.95, 2) if price else None
        ...
        plan = OrderPlan(
            ...
            target_dte=target_dte,
            target_delta=target_delta,
            notes="Bull put template — target credit ≈ 1/3 width",
